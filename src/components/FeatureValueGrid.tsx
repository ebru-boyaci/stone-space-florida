  ...
  return (
    <li className="w-[min(88vw,26.5rem)] shrink-0 snap-start sm:w-[min(80vw,29rem)] md:w-[min(74vw,31rem)]">
      {item.to ? (
        <Link
          to={item.to}
          className="block h-full text-inherit no-underline outline-offset-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#a88d70]"
        >
          {article}
        </Link>
      ) : (
